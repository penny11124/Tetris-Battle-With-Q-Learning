...
class TetrisGameSingle(TetrisGame):
    ...
    ################################################################################
        ...
        while running:
            # battlemusic.play()#plays music
            # print(tetris.block.block_type(), tetris.px, tetris.py)
            tetris.natural_down()
            ...
            if tetris.is_fallen:
                ...
                # print("holes: ", holes)
                # print("n_used_block: ", tetris.n_used_block)
                # print("scores: ", scores)
                # print("cleared: ", tetris.cleared)
                print("height_for_col: ", heights_for_col)
                ...
                # infos['average_height'] = sum(height_for_col) / len(height_for_col)
